...
const Login = () => {
    ...
    return (
        <div class="grid">
            <div class="col-12 md:col-2 lg:col-4"></div>
            ...
            <Card style={{marginTop:"20%"}}>
                ...
                <div className="p-inputgroup" style={inputGroupStyle}>
                    <Button onClick={(e)=>{onSubmit(e)}} style={{width:"100%"}} label={t("login")} className="p-button-outlined" />
                </div>
            </Card>
            </div>
            <div class="col-12 md:col-2 lg:col-4"></div>
    ...
    //         {progress ? (  <ProgressBar mode="indeterminate" style={{height: "4px"}} /> ) : (  <></> )}
    //         </div>
